  ...
  return (
    <div className="container mt-5 pt-3 pt-md-5" style={{ overflowX: 'hidden' }}>
      ...
      <div className="container work-card-group gap-4 mt-5 pt-3 pt-md-5 works-mobile-view">
        <Card2 classname={'work-card'} sl={1} img={support} />
        <Card2 classname={'work-card-reverse'} sl={2} img={planning} />
        <Card2 classname={'work-card'} sl={3} img={updates} />
        <Card2 classname={'work-card-reverse'} sl={4} img={strategy} />
        <Card2 classname={'work-card'} sl={5} img={approved} />
        <Card2 classname={'work-card-reverse'} sl={6} img={goal} />
      </div>
    </div>
  );
};
