...
import Subodh1 from "./Subodh1";
import Subodh2 from "./subodh2";

// import EnrollPlan from "./EnrollPlan";
...
const Enroll = () => {
  ...
  const [page, setpage] = useState("enroll");
  const setPlanpage = () => setpage("enroll");
  // const setplanPage = () => setpage();
                ...
                <div className="col-lg-7" id="enrollPlan-clo2">
                  ...
                  <div className="enrollPlan-clo2-section">
                    <div className="enrollPlan-clo2-section1">
                      ...
                      <p>
                        <i class="bi bi-check-circle-fill"></i>Personal
                        IIT/AIIMS Mentor
                      </p>
                      <p>
                        <i class="bi bi-check-circle-fill"></i>Regular Video
                        Call Session
                      </p>
                      <p>
                      ...
                      <p>
                        <i class="bi bi-check-circle-fill"></i>Progress track
                        and task assign
                      </p>
                      <p>
                        <i class="bi bi-check-circle-fill"></i>Parents-Mentor
                        Meet
                      </p>
                      <p>
                        <i
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        ...
                        elit. Labore, illum earum esse officiis vitae quidem
                        repudiandae vel provident porro perspiciatis expedita
                        recusandae sed? Dignissimos cumque repudiandae
                        accusantium earum in voluptatibus.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Ipsam ducimus ad fugit recusandae qui magnam nisi
                        adipisci aspernatur quod possimus, perferendis molestias
                        minima! Culpa odit provident eveniet debitis mollitia
                        repellendus ipsum sit itaque commodi in velit assumenda
                        excepturi, qui fuga illum incidunt, ipsa laboriosam
                        tenetur. Temporibus ab suscipit et eaque.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
